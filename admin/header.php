    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute
        ...
        <div class="container-fluid">
          ...
          <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navigation" aria-expanded="false" aria-label="Toggle
                            navigation">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="dropdown nav-item">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                  ...
                  <b class="caret d-none d-lg-block
                                            d-xl-block"></b>
                  <p class="d-lg-none">
                    Log out
                  </p>
          ...
          <a href="javascript:void(0)" class="switch-trigger
            ...
            <div class="badge-colors text-center">
              <span class="badge filter badge-primary
                    active" data-color="primary"></span>
